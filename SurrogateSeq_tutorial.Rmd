...
First, load the package from github with the code below. If you have never installed the package devtools, you will need to do that; see the commented out code below.
