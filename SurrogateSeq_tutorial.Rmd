...
This function takes as inputs 1) the surrogate data from the treatment and control groups from Study B, and 2) the surrogate and outcome data for the control group only from Study A.  We will use real AIDS clinical trial data available in the package.
